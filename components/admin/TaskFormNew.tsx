    ...
    <div className="h-full flex flex-col">
      ...
      {showConfirmModal && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center pointer-events-none">
          <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4 space-y-4 relative pointer-events-auto">
      ...
      <form onSubmit={form.handleSubmit(handleSubmit)} className="flex-1 space-y-4 sm:space-y-6 pb-4">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              <div className="space-y-3">
                <Label htmlFor="due_time">Due Time (Auto-filled based on timing)</Label>
                ...
                <p className="text-xs text-muted-foreground">
                  Auto-filled based on timing selection.
                </p>
              </div>
            </div>
          </CardContent>
                    ...
                    <div className="space-y-2">
                      {RESPONSIBILITY_OPTIONS.map(responsibility => (
                        <div
                          ...
                          onClick={() => addArrayItem('responsibility', responsibility.value)}
                        >
                          <Checkbox
                    ...
                    <div className="space-y-2">
                      {TASK_CATEGORIES.map(category => (
                        <div
                          key={category.value}
                          className="flex items-center space-x-2 p-2 hover:bg-gray-50 rounded cursor-pointer"
                          onClick={() => addArrayItem('categories', category.value)}
                        >
                          <Checkbox
